      ...
      {!successMessage && (
        ...
        >
          <input
            ...
            className="w-full max-w-[300px] bg-slate-100 dark:bg-slate-900 outline-none ring-1 ring-slate-200 dark:ring-transparent focus:ring-slate-700 text-white px-6 py-4 rounded-lg placeholder:text-slate-500/50"
          />
          <div className="[--tw-border-width:2px] rounded-full button-gradient from-indigo-500 from-30% via-amber-500 via-50% to-indigo-500 to-70% shadow-lg shadow-indigo-500/50">
            {loading ? (
              <Loader className="rounded-full bg-slate-50 dark:bg-slate-950 transition-all duration-300 px-8 py-2 hover:px-16" />
            ) : (
              <button
                type="submit"
                className="rounded-full bg-slate-50 dark:bg-slate-950 transition-all duration-300 px-8 py-4 hover:px-16"
              >
